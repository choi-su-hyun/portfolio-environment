...
let damageSectionMove = document.querySelector('#section-amount-of-damage-ani-move');
let damageSectionVideo = document.querySelector('#section-amount-of-damage video');
...
function viewPosition() {
  ...
  else if (window.scrollY > (heroSectionHeight / 5) && window.scrollY < (heroSectionHeight / 5 * 2)) {
    // console.log('작동2')
    document.addEventListener('scroll', heroSectionAnimation2);

    function heroSectionAnimation2() {
      let value = (window.scrollY - (heroSectionHeight / 5)) / (heroSectionHeight / 5 * 2) * 100;
      // console.log(`value : ${value}%`);
  ...
  else if (window.scrollY > (heroSectionHeight / 5 * 2) && window.scrollY <= (heroSectionHeight / 5 * 3)) {
    // console.log('작동3')
    document.addEventListener('scroll', heroSectionAnimation3);

    function heroSectionAnimation3() {
      let value = (window.scrollY - (heroSectionHeight / 5 * 2)) / (heroSectionHeight / 5 * 1) * 100;
      // console.log(`value : ${value}%`);
  ...
  if (graphSection.getBoundingClientRect().top < window.innerHeight && graphSection.getBoundingClientRect().top >= 0) {
    ...
    function graphSectionEvent() {
      ...
      let value = (100 - ((graphSection.getBoundingClientRect().top) / window.innerHeight) * 100) * 6;
      if (value <= 0) {
        value = 0;
      }
  ...
  if (matchMedia("screen and (min-width: 768px)").matches) {
    if (helpMeSection.getBoundingClientRect().top < window.innerHeight && helpMeSection.getBoundingClientRect().top > 0) {
      document.addEventListener('scroll', doTextBlur);

      function doTextBlur() {
        let value1 = helpMeSection.getBoundingClientRect().top / (window.innerHeight * 6) * 100;
        let value2 = helpMeSection.getBoundingClientRect().top / window.innerHeight * 100;
  ...
  if (getComputedStyle(lockOff3).display == 'block') {
    ...
    // gsap.to(".plan-item.ani__item1 .plan-item__title-wrap", {
    //   scrollTrigger: {
    //     trigger: ".plan-item.ani__item1 .plan-item__title-wrap",
    //     // toggleActions: "restart none reverse none"
    //   },
    ...
    //   opacity: 1
    // })
    // gsap.to(".plan-item.ani__item1 .plan-item__list-wrap", {
    //   scrollTrigger: {
    //     trigger: ".plan-item.ani__item1 .plan-item__list-wrap",
    //     // toggleActions: "restart none reverse none"
    //   },
    ...
    //   opacity: 1
    // })
    // gsap.to(".plan-item.ani__item1 .plan-item__image-wrap", {
    //   scrollTrigger: {
    //     trigger: ".plan-item.ani__item1 .plan-item__image-wrap",
    //     // toggleActions: "restart none reverse none"
    //   },
    ...
    //   duration: 0.8
    // })
    // gsap.to(".plan-item.ani__item2 .plan-item__title-wrap", {
    //   scrollTrigger: {
    //     trigger: ".plan-item.ani__item2 .plan-item__title-wrap",
    //     // toggleActions: "restart none reverse none"
    //   },
    ...
    //   opacity: 1
    // })
    // gsap.to(".plan-item.ani__item2 .plan-item__list-wrap", {
    //   scrollTrigger: {
    //     trigger: ".plan-item.ani__item2 .plan-item__list-wrap",
    //     // toggleActions: "restart none reverse none"
    //   },
    ...
    // gsap.to(".plan-item.ani__item2 .plan-item__image-wrap", {
    //   scrollTrigger: {
    //     trigger: ".plan-item.ani__item2 .plan-item__image-wrap",
    //     // toggleActions: "restart none reverse none"
    //   },
    ...
    // gsap.to(".plan-item.ani__item3 .plan-item__title-wrap", {
    //   scrollTrigger: {
    //     trigger: ".plan-item.ani__item3 .plan-item__title-wrap",
    //     // toggleActions: "restart none reverse none"
    //   },
    ...
    //   opacity: 1
    // })
    // gsap.to(".plan-item.ani__item3 .plan-item__list-wrap", {
    //   scrollTrigger: {
    //     trigger: ".plan-item.ani__item3 .plan-item__list-wrap",
    //     // toggleActions: "restart none reverse none"
    //   },
    ...
    //   opacity: 1
    // })
    // gsap.to(".plan-item.ani__item3 .plan-item__image-wrap", {
    //   scrollTrigger: {
    //     trigger: ".plan-item.ani__item3 .plan-item__image-wrap",
    //     // toggleActions: "restart none reverse none"
    //   },
    ...
    // gsap.to(".plan-item.ani__item4 .plan-item__title-wrap", {
    //   scrollTrigger: {
    //     trigger: ".plan-item.ani__item4 .plan-item__title-wrap",
    //     // toggleActions: "restart none reverse none"
    //   },
    ...
    //   opacity: 1
    // })
    // gsap.to(".plan-item.ani__item4 .plan-item__list-wrap", {
    //   scrollTrigger: {
    //     trigger: ".plan-item.ani__item4 .plan-item__list-wrap",
    //     // toggleActions: "restart none reverse none"
    //   },
    ...
    //   opacity: 1
    // })
    // gsap.to(".plan-item.ani__item4 .plan-item__image-wrap", {
    //   scrollTrigger: {
    //     trigger: ".plan-item.ani__item4 .plan-item__image-wrap",
    //     // toggleActions: "restart none reverse none"
    //   },
    ...
    let planImage1 = document.querySelector('.ani__item1 .plan-item__image-wrap');
    let planTitle1 = document.querySelector('.ani__item1 .plan-item__title-wrap');
    let planParag1 = document.querySelector('.ani__item1 .plan-item__list-wrap');

    let planWrap2 = document.querySelector('.plan-item.ani__item2');
    let planImage2 = document.querySelector('.ani__item2 .plan-item__image-wrap');
    let planTitle2 = document.querySelector('.ani__item2 .plan-item__title-wrap');
    let planParag2 = document.querySelector('.ani__item2 .plan-item__list-wrap');

    let planWrap3 = document.querySelector('.plan-item.ani__item3');
    let planImage3 = document.querySelector('.ani__item3 .plan-item__image-wrap');
    let planTitle3 = document.querySelector('.ani__item3 .plan-item__title-wrap');
    let planParag3 = document.querySelector('.ani__item3 .plan-item__list-wrap');

    let planWrap4 = document.querySelector('.plan-item.ani__item4');
    let planImage4 = document.querySelector('.ani__item4 .plan-item__image-wrap');
    let planTitle4 = document.querySelector('.ani__item4 .plan-item__title-wrap');
    let planParag4 = document.querySelector('.ani__item4 .plan-item__list-wrap');
...
const temperatureAppear = (el) => {
  ...
  el.parentElement.querySelector('.click-induction__wrap').style.display = 'none';
